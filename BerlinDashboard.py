...
def get_data():
    url = 'https://www.berlin.de/lageso/_assets/gesundheit/publikationen/corona/meldedatum_bezirk.csv'
...
st.write('''
    Dashboard created by **Morteza Sharifi**, with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/morteza-sharifi1/Covid-19-Dasboard).
